...
const pages = [
    ...
    { name: 'Almacenes', href: '/core/almacenes', current: true },
  ]

const minBusqueda = 3

const titulo = "Almacenes"
...
const AlmacenHome = () => {
    ...
    const handleEditar = (almacenId) => {
        router.push(`/core/almacenes/editar/${almacenId}`)
    }
        ...
        <>
            ...
            <div className="bg-gray-200 rounded-lg shadow-md p-4 mt-2 " >
                ...
                <div className="mt-4 flex md:ml-4 md:mt-0">
                    <Link href="/core/almacenes/nuevo" >
                        <button
                            type="button"
                        ...
                        <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            {almacenes.length > 0 && (
                                almacenes.map((almacen) => (
                                    <li key={almacen._id} onDoubleClick={() => handleEditar(almacen._id)} className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow">
