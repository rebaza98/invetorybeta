...
const titulo = "Nueva Empresa"


const NuevaEmpresaHome = () => {
    ...
    */
    ...
    const handleSubmit = async (e) => {
        ...
        if (errores.length === 0){
            ...
            try{
                const response = await fetch('/api/core/empresa/nuevo', {
                    method: 'POST',
                    body: JSON.stringify({
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-2">
                                        <input
                                            ...
                                            onChange={(e) => setFormValues({
                                                ...formValues,
                                                nombreComercial: e.target.value.toLocaleUpperCase()
                                            })}
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-2">
                                        <input
                                            ...
                                            onChange={(e) => setFormValues({
                                                ...formValues,
                                                siglas: e.target.value.toLocaleUpperCase()
                                            })}
