...
const pages = [
    ...
    { name: 'Editar Persona', href: '#', current: true },
  ]

const titulo = "Editar Persona"


const EditarPersonaHome = ({params}) => {
    ...
    const getDatosPersona = async () => {
        const toastId = toast.loading('Cargando Datos de Persona...', { autoClose: false });
        const response = await fetch(`/api/core/persona/buscar/${numeroDoc}`)
    ...
    useEffect(() => {
        ...
        // console.log("FORMVALUES EN USE EFFECT = ", formValues)
        // dispatch(
    ...
    */
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // response = await axios.get(`/api/core/persona/buscar?q=${formValues.numeroDoc}`);
            // data = response.data;
            // if (data.length > 0){
        ...
        if (errores.length === 0){
            ...
            try{
                const response = await fetch(`/api/core/persona/editar/${formValues._id}`, {
                    method: 'PATCH',
                    body: JSON.stringify({
                        id: formValues._id,
                        razonSocial: formValues.razonSocial,
                                ...
                                <div className="sm:col-span-1">
                                    ...
                                    <div className="mt-2 flex">
                                        <input
                                            ...
                                            className={`block w-full uppercase rounded-l-md  py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-slate-200 ${
...
export default EditarPersonaHome