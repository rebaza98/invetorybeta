...
import SearchREMovimientoAlmacen from "@/app/components/inventario/movimientoAlmacen/SearchREMovimientoAlmacen"
import ModalResumenMovimientoAlmacenERF from "@/app/components/inventario/movimientoAlmacen/resumen/ModalResumenMovimientoAlmacenERF"




const titulo = "Entrada Regulacion Fisica"

const NuevaEntradaRegulacionHome = ({ params }) => {

  const tipoMovimientoAlmacen = "ERF"  
  ...
  const pages = [
    ...
    { name: 'Entrada Regulacion Fisica', href: '#', current: true },
]
      ...
      <>
        ...
        <div className="bg-gray-200 rounded-lg shadow-md p-4 mt-2">
          <form onSubmit={handleSubmit} className="">
            {/* modales */}
            {modalResumen && (<ModalResumenMovimientoAlmacenERF params={params} movimiento={formValues} empresa={empresaSeleccionada} almacen={almacenSeleccionado} open={modalResumen} setOpen={setModalResumen} totalItems={totalItems} totalValor={totalValor} />)}
            ...
            <div className="bg-white">
              <div className="mx-auto max-w-2xl px-4 pb-24 pt-8 sm:px-6 lg:max-w-7xl lg:px-8">
                <h3 className="text-xl  font-semibold leading-7 m-3 text-gray-900">Seleccion de Regulacion Entrada</h3>
                {empresaSeleccionada.nombreEmpresa ? (
                  <SearchREMovimientoAlmacen formValues={formValues} setFormValues={setFormValues} empresaSeleccionada={empresaSeleccionada} />
                ):(
                  <LoadingComponent mensaje={"Cargando datos.."} />
                )}
...
export default NuevaEntradaRegulacionHome