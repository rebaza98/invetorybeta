...
const CModalIngresaProveedorOC = ({ open, setOpen, formValues, setFormValues }) => {
    ...
    const handleProvedorUpdate = (persona) => {
        setFormValues({
            ...formValues,
            proveedor: {
                            ...
                            <div className="mt-1 sm:mt-2">
                                    <div className='flex justify-center' >
                                        ...
                                        <span className='ml-4' >
                                            ...
                                            {modalIngresaPersona && <CModalIngresaPersona open={modalIngresaPersona} setOpen={setModalIngresaPersona} setParentModal={setOpen} handlerCreatePersona={handleProvedorUpdate} />}
                                        </span>
                                    </div>
