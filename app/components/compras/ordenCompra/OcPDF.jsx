...
//     flexGrow: 1,
//   },
// });    {String(oc.ocEmpresa).padStart(5, '0')}
          ...
          <View style={tw("flex w-full justify-between flex-row gap-2")} >
            <View style={tw("w-3/6 p-2")} >
              ...
              <Text style={tw("text-xs font-bold")} >
                Razon Social: {oc.proveedor?.razonSocial}
              </Text>
              <Text style={tw("text-xs font-bold")} >
                {oc.proveedor?.docId.nombre}: {oc.proveedor?.numeroDoc}
              </Text>
              <Text style={tw("text-xs font-bold")} >
              ...
              {oc.ingresadoAlmacen && (
                <>
                  <View style={tw("flex flex-row justify-between")} >
                    ...
                    <Text style={tw("text-xs m-0")} >
                      {String(oc.movAlmacen.movimientoRef.movimientoEmpresa).padStart(5, '0')}
                    </Text>
                  </View>
                  <View style={tw("flex flex-row justify-between")} >
                    <Text style={tw("text-xs m-0")} >
                    ...
                    <Text style={tw("text-xs m-0")} >
                      {formatearFecha(oc.movAlmacen.movimientoRef.fechaMovimiento)}
                    </Text>
                  </View>
                </>
              )}
          ...
          <View style={tw("flex mt-4 flex-row text-center justify-end")} >
            <View style={tw("w-2/5 border rounded-md mt-2 p-2")} >
              <View style={tw("text-sm flex flex-row text-left justify-between")} >
                ...
                <Text>
                  {parseFloat(oc.subTotal).toFixed(2)}
                </Text>
              </View>
              <View style={tw("text-sm flex flex-row text-left justify-between")} >
                <Text>
                ...
                <Text>
                  {parseFloat(oc.impuesto).toFixed(2)}
                </Text>
              </View>
              <View style={tw("text-base mt-2 flex flex-row text-left justify-between")} >
                ...
                <Text>
                  S/.{parseFloat(oc.total).toFixed(2)}
                </Text>
              </View>
            </View>
