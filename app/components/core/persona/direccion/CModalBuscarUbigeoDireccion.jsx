...
import SearchUbigeoDireccion from './SearchUbigeoDireccion'




const CModalBuscarUbigeoDireccion = ({ open, setOpen, formDirecValues, setFormDirecValues }) => {
                    ...
                    <Dialog.Panel className="relative transform  rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 lg:w-full sm:max-w-lg sm:p-6">
                        ...
                        <div className="mt-1 sm:mt-2">
                            ...
                            <form className="mt-4 mb-2 w-80 max-w-screen-lg sm:w-full">
                                <div>
                                    <SearchUbigeoDireccion formDirecValues={formDirecValues} setFormDirecValues={setFormDirecValues} setOpen={setOpen} />
                                </div>
...
export default CModalBuscarUbigeoDireccion