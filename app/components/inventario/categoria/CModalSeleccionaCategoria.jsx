...
export default function CModalSeleccionaCategoria({open, setOpen, categoria, setCategoria}) {
  ...
  useEffect( () => {
    const fetchCategorias = async () => {
      const response = await fetch('/api/inventario/producto/categoria')
  ...
  categorias.map((valor) => {
    let current = { value: valor._id, label: valor.nombreCategoria }
  ...
  const handleSeleccionar = () => {
    ...
    setCategoria(selectedOptionNombre)
    setOpen(false)
                      ...
                      <div className="mb-4 flex flex-col gap-6">
                        ...
                        <div className="relative h-11 w-full min-w-[200px]">
                          <Select
                            ...
                            options={options}
                            placeholder="Seleecione una Categoria"
                            isClearable
                            required
