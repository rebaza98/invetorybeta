...
const LineaDetalleProcesoEntrada = ({proceso, producto, formValues, setFormValues}) => {
                    ...
                    {producto.detalle.map((current, i) => (
                        <div key={current.index} style={{ position: 'relative' }}>
                            <input
                                ...
                                className={`mt-2 mr-2 p-2 border  rounded-md focus:ring focus:ring-indigo-200 focus:outline-none focus:border-indigo-500 block w-5/11 shadow-sm sm:text-sm  
...
export default LineaDetalleProcesoEntrada
