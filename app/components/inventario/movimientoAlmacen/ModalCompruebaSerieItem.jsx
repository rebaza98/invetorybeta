...
const ModalCompruebaSerieItem = ({ open, setOpen, proceso, producto, formValues, setFormValues, itemsValidados, setItemsValidados, validaTodosItems }) => {
...
export default ModalCompruebaSerieItem