...
const ModalResumenMovimientoAlmacenERF = ({params, movimiento, empresa, almacen, open, setOpen, totalItems, totalValor}) => {
    ...
    const handleGuardarClick = async() => {
        ...
        try{
            ...
            const response = await fetch('/api/inventario/movimientoAlmacen/entrada/regulacion/nuevo', {
                method: 'POST',
                body: JSON.stringify({
                                                                ...
                                                                <tbody>
                                                                    {movimiento.proceso.map((proceso, idx) => (
                                                                        ...
                                                                        <tr key={idx}>
                                                                            ...
                                                                            >
                                                                                {String(proceso.regulacionEntradaEmpresa).padStart(5, '0')}
                                                                            </td>
...
export default ModalResumenMovimientoAlmacenERF
