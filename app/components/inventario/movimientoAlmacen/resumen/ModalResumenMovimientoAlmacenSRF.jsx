...
const ModalResumenMovimientoAlmacenSRF = ({params, movimiento, empresa, almacen, open, setOpen, totalItems, totalValor}) => {
    ...
    const handleGuardarClick = async() => {
        ...
        try{
            ...
            const response = await fetch('/api/inventario/movimientoAlmacen/salida/regulacion/nuevo', {
                method: 'POST',
                body: JSON.stringify({
                                                                ...
                                                                <tbody>
                                                                    {movimiento.proceso.map((proceso, idx) => (
                                                                        ...
                                                                        <tr key={idx}>
                                                                            ...
                                                                            >
                                                                                {String(proceso.regulacionSalidaEmpresa).padStart(5, '0')}
                                                                            </td>
...
export default ModalResumenMovimientoAlmacenSRF
