...
const ModalIngresaSerieItem = ({ open, setOpen, formValues, setFormValues, currentProducto, currentIndex }) => {

    console.log("CURRENT PRODUCTO EN MODAL = ", currentProducto)
    console.log("CURRENT INDEX EN MODAL = ", currentIndex)
    console.log("FOMSMAVALUES = MODLA = ", formValues)
...
export default ModalIngresaSerieItem