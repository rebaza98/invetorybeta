...
const ModalListaProductosRS = ({ open, setOpen, idRe }) => {

    
    const [re, setRe] = useState({formRegulacionEntradaInit})

    //asyncs
    const fetchPopulateData = async () => {
        const response = await fetch(`/api/regulaciones/regulacionEntrada/buscar/${idRe}`)
                                ...
                                <div className='border-2' >
                                    <div className="mt-3  sm:mt-5">
                                        <Dialog.Title as="h3" className="text-base text-center font-semibold leading-6 text-gray-900">
                                            {re.regulacionEntradaEmpresa ? (
                                                `Regulacion Entrada: ${String(re.regulacionEntradaEmpresa).padStart(5, '0')}`
                                            ) : (
...
export default ModalListaProductosRS
