...
import SearchClienteFinalOV from './SearchClienteFinalOV'




const CModalIngresaClienteFinalOV = ({ open, setOpen, formValues, setFormValues }) => {
    ...
    const handleClienteUpdate = (persona) => {
        console.log("VALORES PEROSNA = ", persona)

        setFormValues({
            ...formValues,
            clienteFinal: {
                ...formValues.clienteFinal,
                personaRef: persona._id,
                            ...
                            <div className="mt-1 sm:mt-2">
                                    <div className='flex justify-center' >
                                        ...
                                        <span className='ml-4' >
                                            ...
                                            {modalIngresaPersona && <CModalIngresaPersona open={modalIngresaPersona} setOpen={setModalIngresaPersona} setParentModal={setOpen} handlerCreatePersona={handleClienteUpdate} />}
                                        </span>
                                    </div>
                                ...
                                <form className="mt-4 mb-2 w-80 max-w-screen-lg sm:w-full">
                                    <div>
                                        <SearchClienteFinalOV formValues={formValues} setFormValues={setFormValues} setOpen={setOpen} />
                                    </div>
...
export default CModalIngresaClienteFinalOV